...
<div class=" flex items-center flex-wrape gap-2 text-xs sm:test-sm mb-4">
    {#each reviewItem.features as keywork}
    <div class="p-1 py 0.5 rounded-md border border-solid border-indigo-400 bg-indigo-50 text-indogo-400 ">
        <p>{keywork}</p>
    </div>
    {/each}
</div>
